...
const CounselingStatusUpdateModal = ({
  isOpen,
  onClose,
  reportCode,
  newCounselingStatus,
  setNewCounselingStatus,
  onUpdate,
  loading,
  error
}) => {
        ...
        <div className="bg-white rounded-xl shadow-xl w-full max-w-md overflow-hidden">
          <div className="p-6">
            ...
            <div className="mb-6">
              ...
              <select
                value={newCounselingStatus}
                onChange={(e) => setNewCounselingStatus(e.target.value)}
...
export default CounselingStatusUpdateModal;